...
- **Smart Pet Wearable — Bayesian Network & Survey Validation**  
  Bayesian network modeling of success drivers + survey design and statistical testing of key causal links.

> Code is provided in R and/or Stata. Some datasets are not included due to licensing/privacy.
